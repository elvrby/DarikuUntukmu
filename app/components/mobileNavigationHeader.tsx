...
const MobileNavigationHeader: React.FC<mobileNavigationHeaderProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className={`fixed z-50 top-0 right-0 navbar w-full h-full transform lg:-96 ${isOpen ? "translate-x-0" : "translate-x-full"} transition-transform duration-300 ease-in-out`}>
            ...
            <div className="mt-3 w-full flex flex-col bg-[#4A4A4A] rounded-lg border-[#4A4A4A] border-2">
              <button onClick={handleToggleNavbar} className="bg-[#4A4A4A] hover:bg-[#535353] w-full p-4 flex items-center justify-between text-white">
                <svg className="w-5 mr-4" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M10 20C15.5228 20 20 15.5228 20 10C20 4.47715 15.5228 0 10 0C4.47715 0 0 4.47715 0 10C0 15.5228 4.47715 20 10 20ZM10 18V2C14.4183 2 18 5.58172 18 10C18 14.4183 14.4183 18 10 18Z"
                    fill="#DADADA"
                  />
                </svg>
